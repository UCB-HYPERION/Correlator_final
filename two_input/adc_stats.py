...
time.sleep(1)
s.write_int('snap_adc0_ctrl',1)
s.write_int('snap_adc0_ctrl',0)

adc_data = s.snapshot_get('snap_adc0',man_trig=True,man_valid=True)
ad = struct.unpack('>2048b',adc_data['data'])
ad = np.asarray(ad)
...
print "Hey this is the max value"
print np.amax(ad)

print "Hey this is the min value"
print np.amin(ad)
