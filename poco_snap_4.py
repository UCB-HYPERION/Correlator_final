...
def get_data(r):
    ...
    """
    rv = {}
    rv['3_auto']  = np.fromstring(r.read('ac_a3_real', 8*NCHANS), dtype='>i8')
    rv['4_auto']  = np.fromstring(r.read('ac_a4_real', 8*NCHANS), dtype='>i8')
    rv['7_auto']  = np.fromstring(r.read('ac_a7_real', 8*NCHANS), dtype='>i8')
    rv['8_auto']  = np.fromstring(r.read('ac_a8_real', 8*NCHANS), dtype='>i8')
    rv['3_4_cross']  = np.fromstring(r.read('cc_a3_a4_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a3_a4_imag', 8*NCHANS), dtype='>i8')
    rv['3_7_cross']  = np.fromstring(r.read('cc_a3_a7_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a3_a7_imag', 8*NCHANS), dtype='>i8')
    rv['3_8_cross']  = np.fromstring(r.read('cc_a3_a8_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a3_a8_imag', 8*NCHANS), dtype='>i8')
    rv['4_7_cross']  = np.fromstring(r.read('cc_a4_a7_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a4_a7_imag', 8*NCHANS), dtype='>i8')
    rv['4_8_cross']  = np.fromstring(r.read('cc_a4_a8_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a4_a8_imag', 8*NCHANS), dtype='>i8')
    rv['7_8_cross']  = np.fromstring(r.read('cc_a7_a8_real', 8*NCHANS), dtype='>i8') + 1j*np.fromstring(r.read('cc_a7_a8_imag', 8*NCHANS), dtype='>i8')
    return rv
